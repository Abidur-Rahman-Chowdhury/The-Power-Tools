  ...
  return (
    <div className="mb-5" >
      <div className="text-center" data-aos="fade-up" >
        <motion.h2 className="text-3xl italic text-center font-bold border-b-2 inline-block " initial={{y: -100}} animate={{y: 0}} transition={{duration: 2}}>
          About Us
        </motion.h2>
      </div>

      <motion.p className="text-center text-xl mt-4 px-16" initial={{x: -2000 }} animate ={{x:0}}  transition={{duration: 3}}>
